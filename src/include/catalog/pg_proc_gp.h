...
/* gp_backend_info(OUT id int4, OUT type "char", OUT content int4, OUT host text, OUT port int4, OUT pid int4) => SETOF record */
DATA(insert OID = 6998 ( gp_backend_info  PGNSP PGUID 12 1 1000 0 0 f f f f f t v 0 0 2249 "" "{23,18,23,25,23,23}" "{o,o,o,o,o,o}" "{id,type,content,host,port,pid}" _null_ gp_backend_info _null_ _null_ _null_ n a ));
DESCR("debugging information for segment backends");
