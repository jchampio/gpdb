...
-- System-view support functions 
 ...
 CREATE FUNCTION gp_gang_info(OUT gangid int4, OUT type "char", OUT content int4, OUT host text, OUT port int4, OUT pid int4) RETURNS SETOF record LANGUAGE internal VOLATILE AS 'gp_gang_info' WITH (OID=6998, DESCRIPTION="TODO");
